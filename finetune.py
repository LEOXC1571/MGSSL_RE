...
from utils.model import GNN, GNN_graphpred
...
def main():
    ...
    parser.add_argument('--input_model_file', type=str,
                        default='../motif_based_pretrain/saved_model/motif_pretrain.pth',
    ...
    #set up model
    model = GNN_graphpred(args.n_layer, args.emb_dim, num_tasks, JK = args.JK, drop_ratio = args.dropout, graph_pooling = args.graphpooling, gnn_type = args.gnn)
    ...
    if args.graphpooling == "attention":
